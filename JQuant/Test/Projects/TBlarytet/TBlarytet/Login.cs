...
namespace FMRShell
{
	...
	public class Connection : IDisposable
	{
		...
		private void Init()
		{
            ...
            TaskBarLibSim.UserClass userClass = new TaskBarLibSim.UserClass();
		}
	...
	public class ConnectionParameters
	{
        ...
        /// <summary>
        /// Not required anymore, but kept in the API for historical reasons
        /// Generally pass an empty string - "" - for it
        /// </summary>
    ...
    class FMRShellTest
    {
        public static void Main(string[] args)
        {
            ...
            else Console.WriteLine("Connection successfully established, SessionID: {0}", result);
        }
    }
}
